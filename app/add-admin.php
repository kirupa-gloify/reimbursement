...
if (isset($_POST["submit"])) {
  ...
  $sql = "insert into register (username,emailaddress,password,status,position) VALUES ('$name','$email','$password','APPROVED','$position')";
  $res = mysqli_query($con, $sql);
  if ($res) {
    header("Location: " . $siteURL . "add-admin.php?result=success");
  } else {
...
<div class="br-mainpanel">
  <div class="br-pageheader pd-y-15 pd-l-20">
    <nav class="breadcrumb pd-0 mg-0 tx-12">
      ...
      <a class="breadcrumb-item" href="manage-user.php">Manage User</a>
          ...
          <div class="col-xl-12">
            ...
            <div class="form-layout form-layout-4">
              ...
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <select type="password" class="form-control" name="position" required="">
            ...
            <div class="form-layout-footer mg-t-30">
              <button type="submit" name="submit" id="submit" class="btn btn-info">Add Admin</button>
